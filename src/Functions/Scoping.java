...
public class Scoping {
    ...
    public static void main(String[] args) {
         ...
         */
        {
//            int a = 34; we cannot re-initialize.
            a = 89;
    ...
    static int sum(int num1, int num2) {
        Scoping InstanceVariable = new Scoping();
        InstanceVariable.num = 23;
        System.out.println("Re-initializing the InstanceVariable:" + InstanceVariable.num);
